...
namespace DiamondDrillingReport.Migrations
{
    ...
    partial class DiamondDrillingReportContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiamondDrillingReport.Models.Area", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DiamondDrillingReport.Models.CreateDailyReport", b =>
                {
                    ...
                    b.Property<int>("CrewDayID");

                    //b.Property<int?>("CrewID");

                    b.Property<int>("CrewNightID");
                    ...
                    b.Property<int>("EquipmentDayID");

                    //b.Property<int?>("EquipmentId");

                    b.Property<int>("EquipmentNightID");

                    b.Property<decimal>("HoleDepthToDay");

                    b.Property<decimal>("HoleDepthToNight");
            ...
            modelBuilder.Entity("DiamondDrillingReport.Models.DrillProgram", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DiamondDrillingReport.Models.Equipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("HullNumber");

                    b.Property<string>("WatertruckName");
            ...
            modelBuilder.Entity("DiamondDrillingReport.Models.Hole", b =>
                {
                    ...
                    b.Property<DateTime>("HoleEndDate");

                    b.Property<DateTime>("HoleStartDate");

                    b.Property<int>("HoleStatusID");

                    b.Property<int>("HoleZoneID");
                    ...
                    b.HasIndex("DrillProgramID");

                    b.HasIndex("HoleStatusID");

                    b.HasIndex("HoleZoneID");

                    b.ToTable("Hole");
                });

            modelBuilder.Entity("DiamondDrillingReport.Models.HoleStatus", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("HoleStatus");
                });

            modelBuilder.Entity("DiamondDrillingReport.Models.HoleZone", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DiamondDrillingReport.Models.CreateDailyReport", b =>
                {
                    b.HasOne("DiamondDrillingReport.Models.Crew", "Crew")
                        .WithMany("CreateDailyReports")
                        .HasForeignKey("CrewDayID");

                    b.HasOne("DiamondDrillingReport.Models.Crew", "Crew")
                        .WithMany("CreateDailyReports")
                        .HasForeignKey("CrewNightID");

                    b.HasOne("DiamondDrillingReport.Models.Equipment", "Equipment")
                        .WithMany("CreateDailyReports")
                        .HasForeignKey("EquipmentDayID");

                    b.HasOne("DiamondDrillingReport.Models.Equipment", "Equipment")
                        .WithMany("CreateDailyReports")
                        .HasForeignKey("EquipmentNightID");
            ...
            modelBuilder.Entity("DiamondDrillingReport.Models.Hole", b =>
                {
                    ...
                    b.HasOne("DiamondDrillingReport.Models.DrillProgram", "DrillProgram")
                        .WithMany("Holes")
                        .HasForeignKey("DrillProgramID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DiamondDrillingReport.Models.HoleStatus", "HoleStatus")
                        .WithMany("Holes")
                        .HasForeignKey("HoleStatusID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DiamondDrillingReport.Models.HoleZone", "HoleZone")
                        .WithMany("Holes")
                        .HasForeignKey("HoleZoneID")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("DiamondDrillingReport.Models.HoleZone", b =>
                {
                    b.HasOne("DiamondDrillingReport.Models.Area", "Area")
                        .WithMany("HoleZones")
